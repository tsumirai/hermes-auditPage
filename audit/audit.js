...
let host = 'https://www.mirthdata.com';
// let host = 'http://124.220.84.200:5455';
...
function fetchActivityData(pageNo) {
    ...
    // 发送GET请求到服务端以获取查询数据
    fetch(host+`/platform/queryActivity?page_no=${pageNo}&page_size=${pageSize}&audit_type=${postType}&activity_id=${activityId}`)
...
function fetchClubData(pageNo) {
    ...
    // 发送GET请求到服务端以获取查询数据
    fetch(host+`/platform/queryClub?page_no=${pageNo}&page_size=${pageSize}&audit_type=${clubType}&club_id=${clubId}`)
        .then(response => response.json())
        .then(data => {
            // 渲染获取的数据
            console.log(data)
...
function fetchActivityResultData(pageNo) {
    ...
    // 发送GET请求到服务端以获取查询数据
    fetch(host+`/platform/queryActivityResult?page_no=${pageNo}&page_size=${pageSize}&audit_type=${postType}&activity_id=${resultId}`)
        .then(response => response.json())
        .then(data => {
            // 渲染获取的数据
            console.log(data)
...
function publishPublicNotice() {
    ...
    // 发送POST请求到服务端以获取查询数据
    fetch(host+`/public_notice/createPublicNotice`,{
        method: 'post',
        headers: {
            'Content-Type':'application/json',
            'Access-Control-Allow-Origin': '*'
...
function fetchPublicNoticeData(pageNo) {
    ...
    // 发送GET请求到服务端以获取查询数据
    fetch(host+`/platform/queryPublicNotice?page_no=${pageNo}&page_size=${pageSize}&notice_type=${noticeType}&notice_id=${noticeId}`)
        .then(response => response.json())
        .then(data => {
            // 渲染获取的数据
            console.log(data)
...
function publishBanner() {
    ...
    // 发送POST请求到服务端以获取查询数据
    fetch(host+`/banner/createBanner`,{
        method: 'post',
        headers: {
            'Content-Type':'application/json',
            'Access-Control-Allow-Origin': '*'
...
function fetchBannerData(pageNo) {
    ...
    // 发送GET请求到服务端以获取查询数据
    fetch(host+`/platform/queryBanner?page_no=${pageNo}&page_size=${pageSize}&banner_type=${bannerType}&banner_id=${bannerId}`)
        .then(response => response.json())
        .then(data => {
            // 渲染获取的数据
            console.log(data)
